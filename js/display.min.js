(function(){var n,y,z,A,p,B,a,i;i="undefined"!==typeof exports&&null!==exports?exports:this;a=null;i.Display=function(){function f(g,b,c){var d=this;this.width=b;this.height=c;a=g;this.ready=!1;this.radiansPerSecond=3.0E-4;this.transitionMilliseconds=750;this.style=n;this.sketchy=!0;this.programs={};this.hotMouse=!1;this.initializeGL();this.gallery=new i.Gallery;this.highlightRow=this.gallery.j;this.worker=new Worker("js/worker.min.js");this.worker.onmessage=function(a){return d.onWorkerMessage(a.data)};
this.worker.postMessage({command:"download-spines",url:document.URL+"data/centerlines.bin"})}f.name="Display";f.prototype.render=function(){var g,b,c,d,e,h,k,j,f,l;this.gallery.row().loaded||this.tessRow();g=(new Date).getTime();if(null!=this.previousTime){c=g-this.previousTime;b=this.radiansPerSecond*c;0===i.pageIndex&&(b*=32);h=null!=(e=this.highlightRow)?e:null;1===i.pageIndex&&(h=this.gallery.j);j=this.gallery.links;c=k=0;for(d=j.length;k<d;c=++k)e=j[c],e.theta=c===h||Math.abs(e.theta%A)>b?e.theta+
b:0}this.previousTime=g;this.projection=mat4.perspective(45,this.width/this.height,5,90);g=mat4.lookAt([0,-5,5],[0,0,0],[0,1,0]);this.updateViewports();k=this.gallery.links;c=b=0;for(h=k.length;b<h;c=++b){e=k[c];d=mat4.create();this.modelview=mat4.create();mat4.identity(d);mat4.rotateX(d,0.785);mat4.rotateY(d,e.theta);mat4.multiply(g,d,this.modelview);this.normalMatrix=mat4.toMat3(this.modelview);j=0;for(f=e.length;j<f;j++)if(d=e[j],0===d.iconified&&(d.alpha=0.3),1===d.iconified)d.alpha=1;j=0;for(f=
e.length;j<f;j++)d=e[j],null==d.hidden&&this.renderIconLink(d,d.tableBox,1);if(c===this.gallery.j){j=0;for(c=e.length;j<c;j++)d=e[j],d.ready&&this.renderIconLink(d,d.iconBox,d.alpha);for(c=f=0;1>=f;c=++f){l=0;for(j=e.length;l<j;l++)d=e[l],this.renderBigLink(d,c)}}}if(a.getError()!==a.NO_ERROR)return glerr("Render")};f.prototype.renderIconLink=function(a,b,c){var d,e,h,k;k=[];e=0;for(h=a.length;e<h;e++)d=a[e],k.push(this.renderIconKnot(d,a,b,c));return k};f.prototype.renderBigLink=function(a,b){var c,
d,e,h;h=[];d=0;for(e=a.length;d<e;d++)c=a[d],h.push(this.renderBigKnot(c,a,b));return h};f.prototype.initializeGL=function(){this.compileShaders();a.enable(a.CULL_FACE);if(a.getError()!==a.NO_ERROR)return glerr("OpenGL error during init")};f.prototype.onWorkerMessage=function(g){var b,c,d,e,h,k;switch(g.command){case "debug-message":return toast(g.text);case "spine-data":return this.spines=this.createVbo(a.ARRAY_BUFFER,g.data),this.spines.scale=g.scale,this.ready=!0;case "mesh-link":b=g.id;d=b[1];
...
d,e);a.linkProgram(f);a.getProgramParameter(f,a.LINK_STATUS)||glerr("Could not link "+g+" with "+b);b=a.getProgramParameter(f,a.ACTIVE_UNIFORMS);d=[];for(g=c=0;0<=b?c<b:c>b;g=0<=b?++c:--c)d.push(a.getActiveUniform(f,g).name);b=0;for(c=d.length;b<c;b++)g=d[b],f[g]=a.getUniformLocation(f,g);return f};return f}();(function(){var a,g,b,c;b=["sin","cos","pow","abs"];c=[];a=0;for(g=b.length;a<g;a++)B=b[a],c.push(Math[B]);return c})();A=2*Math.PI;p=utility.aabb;y=0;n=1;z=2}).call(this);
