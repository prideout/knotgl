...
(function() {
  var CompileProgram, GetKnotPath, GetLinkPaths, InitBuffers, MobiusTube, NORMAL, POSITION, Render, Slices, Stacks, TEXCOORD, TWOPI, VERTEXID, abs, cos, pow, programs, root, sgn, sin, theta, vbos, _ref;
  ...
  GetKnotPath = function(data, slices) {
    var a, b, c, i, p, rawBuffer, t, tt, v1, v2, v3, v4, α, β, γ, ε, _results;
