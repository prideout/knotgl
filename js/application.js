...
(function() {
  var CollapsedSizes, CurrentSizes, ExpandedSizes, assignEventHandlers, box, clone, exportScreenshot, getPagePosition, layout, root, tick, updateNumeralSizes, updateSwipeAnimation;
  ...
  root.AnimateNumerals = function() {
    ...
    root.collapse = new TWEEN.Tween(CurrentSizes).to(CollapsedSizes, duration).easing(TWEEN.Easing.Quintic.In).onUpdate(updateNumeralSizes).onComplete(root.collapse = null);
    root.expand = new TWEEN.Tween(CurrentSizes).to(ExpandedSizes, duration).easing(TWEEN.Easing.Quintic.In).onUpdate(updateNumeralSizes).onComplete(root.expand = null);
    root.collapse.chain(root.expand);
    return root.collapse.start();
  };
