...
(function() {
  var NORMAL, POSITION, Renderer, TEXCOORD, TWOPI, VERTEXID, abs, cos, dot, f, pow, root, sgn, sin, staticRender, _ref;
  ...
  Renderer = (function() {
    ...
    Renderer.prototype.compileShaders = function() {
      ...
      this.programs.mesh = this.compileProgram("VS-Scene", "FS-Scene", attribs, unif);
      attribs = {
        Position: POSITION
      };
      unif = {
      ...
      this.programs.wireframe = this.compileProgram("VS-Wireframe", "FS-Wireframe", attribs, unif);
      attribs = {
        VertexID: VERTEXID
      };
      uniforms = {
      ...
      return this.programs.vignette = this.compileProgram("VS-Vignette", "FS-Vignette", attribs, uniforms);
    };
