...
(function() {
  var Renderer, TWOPI, abs, cos, dot, f, pow, root, sgn, sin, staticRender, _ref;
  ...
  Renderer = (function() {
    ...
    Renderer.prototype.render = function() {
      var aspect, eye, far, fov, knot, model, modelview, near, normalMatrix, offset, program, projection, setColor, stride, target, up, view, _i, _len, _ref;
      ...
      this.knots[2].color = [1, 1, 0.5, 0.75];
      _ref = this.knots;
    ...
    Renderer.prototype.genVertexBuffers = function() {
      var centerline, faceCount, i, j, knot, knotData, lineCount, next, polygonCount, polygonEdge, ptr, rawBuffer, sides, sweepEdge, tri, triangles, tube, v, vbo, wireframe, _i, _len, _ref, _ref1, _ref2, _ref3, _results;
      this.knots = [];
